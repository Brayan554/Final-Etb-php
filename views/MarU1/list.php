...
<head>
  ...
  <title>TAR URBA FEBRERO 15 AL 26</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TAR URBA MARZO 01 AL 15 </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($MarU1s  as $MarU1 ) : ?>
            <tr>
                <td><?php echo $MarU1->idRemedy?></td>
                <td><?php echo $MarU1->NOMBREPREDIO?></td>
                <td><?php echo $MarU1->NEMONICOEQUIPO?></td>
                <td><?php echo $MarU1->TIPODEINSLACION?></td>
                <td><?php echo $MarU1->fecha?></td>
                <td><?php echo $MarU1->LIDERGRUPO?></td>
                
                <td><?php echo $MarU1->DIRECCIONPREDIO?></td>
                <td>
