...
<head>
  ...
  <title>TAR MSAN MAYO 18 AL 31 CRQ000000073462</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">MSAN MAYO 18 AL 31  </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($MayM2s as $MayM2) : ?>
            <tr>
                <td><?php echo $MayM2->idRemedy?></td>
                <td><?php echo $MayM2->NOMBREPREDIO?></td>
                <td><?php echo $MayM2->NEMONICOEQUIPO?></td>
                <td><?php echo $MayM2->DIRECCIONPREDIO?></td>
                <td><?php echo $MayM2->TIPODEINSLACION?></td>
                <td><?php echo $MayM2->fecha?></td>
                <td>
