...
<head>
  ...
  <title>TAR URBA MAYO 18 AL 31 CRQ000000073422</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TAR URBA MAYO 18 AL 31 CRQ000000073422</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Inicio</a></li>
              <li class="breadcrumb-item active">TAR URBA</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($MayU2s  as $MayU2 ) : ?>
            <tr>
                <td><?php echo $MayU2->idRemedy?></td>
                <td><?php echo $MayU2->NOMBREPREDIO?></td>
                <td><?php echo $MayU2->NEMONICOEQUIPO?></td>
                <td><?php echo $MayU2->TIPODEINSLACION?></td>
                <td><?php echo $MayU2->fecha?></td>
                <td><?php echo $MayU2->LIDERGRUPO?></td>
                
                <td><?php echo $MayU2->DIRECCIONPREDIO?></td>
                <td>
                  ...
                  echo $EneM1->idRemedy?>" class="btn btn-primary"><i class="far fa-edit"></i></a>
