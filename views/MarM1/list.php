...
<head>
  ...
  <title>TAR MSAN Marzo 01 AL 15 CRQ000000070086</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">MSAN MARZO 01 AL 15 </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($MarM1s as $MarM1) : ?>
            <tr>
                <td><?php echo $MarM1->idRemedy?></td>
                <td><?php echo $MarM1->NOMBREPREDIO?></td>
                <td><?php echo $MarM1->NEMONICOEQUIPO?></td>
                <td><?php echo $MarM1->DIRECCIONPREDIO?></td>
                <td><?php echo $MarM1->TIPODEINSLACION?></td>
                <td><?php echo $MarM1->fecha?></td>
                <td>
