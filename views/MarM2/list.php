...
<head>
  ...
  <title>TAR MSAN MARZO 16 AL 31 CRQ000000070595</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">MSAN MARZO 16 AL 31 </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($MarM2s as $MarM2) : ?>
            <tr>
                <td><?php echo $MarM2->idRemedy?></td>
                <td><?php echo $MarM2->NOMBREPREDIO?></td>
                <td><?php echo $MarM2->NEMONICOEQUIPO?></td>
                <td><?php echo $MarM2->DIRECCIONPREDIO?></td>
                <td><?php echo $MarM2->TIPODEINSLACION?></td>
                <td><?php echo $MarM2->fecha?></td>
                <td>
