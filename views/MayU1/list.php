...
<head>
  ...
  <title>TAR URBA MAYO 03 AL 14</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TAR URBA MAYO 03 AL 14</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($MayU1s  as $MayU1 ) : ?>
            <tr>
                <td><?php echo $MayU1->idRemedy?></td>
                <td><?php echo $MayU1->NOMBREPREDIO?></td>
                <td><?php echo $MayU1->NEMONICOEQUIPO?></td>
                <td><?php echo $MayU1->TIPODEINSLACION?></td>
                <td><?php echo $MayU1->fecha?></td>
                <td><?php echo $MayU1->LIDERGRUPO?></td>
                
                <td><?php echo $MayU1->DIRECCIONPREDIO?></td>
                <td>
