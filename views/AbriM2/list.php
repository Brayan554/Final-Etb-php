...
<head>
  ...
  <title>TAR MSAN ABRIL 19 AL 30  CRQ000000072766</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">MSAN MSAN ABRIL 19 AL 30</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($AbriM2s  as $AbriM2 ) : ?>
            <tr>
                <td><?php echo $AbriM2->idRemedy?></td>
                <td><?php echo $AbriM2->NOMBREPREDIO?></td>
                <td><?php echo $AbriM2->NEMONICOEQUIPO?></td>
                <td><?php echo $AbriM2->DIRECCIONPREDIO?></td>
                <td><?php echo $AbriM2->TIPODEINSLACION?></td>
                <td><?php echo $AbriM2->fecha?></td>
                <td>
