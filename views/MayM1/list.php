...
<head>
  ...
  <title>TAR MSAN MAYO 03 AL 14 CRQ000000073231</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">MSAN MAYO 03 AL 14 </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($MayM1s as $MayM1) : ?>
            <tr>
                <td><?php echo $MayM1->idRemedy?></td>
                <td><?php echo $MayM1->NOMBREPREDIO?></td>
                <td><?php echo $MayM1->NEMONICOEQUIPO?></td>
                <td><?php echo $MayM1->DIRECCIONPREDIO?></td>
                <td><?php echo $MayM1->TIPODEINSLACION?></td>
                <td><?php echo $MayM1->fecha?></td>
                <td>
